function Robot_Controller_Main(serPort)
...
function [integral, lastError, error] = followWall(serPort, SonFF, SonRight, Kp, Ki, Kd, integral, lastError, desiredDistance, baseSpeed)
